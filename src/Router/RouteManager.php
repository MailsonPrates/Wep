...
class RouteManager
{
     ...
     * the current group.
     * 
     * @return null|\App\Core\Router\RouteGroups
     */
    ...
    public function closureReturn(): array
    {
        ...
        return array_merge([
            /**
             * Retirado esse retorno de parametros
             * para que retorno somente os dados do request
             */
            //$params,
     ...
     * 
     * @return null|\App\Core\Router\Middlewares\MiddlewareCollection
     */
